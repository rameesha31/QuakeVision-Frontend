...
export default function HomeChatbot({ sessionId, reportData, onReportUpdate }) {
  ...
  const sendChat = async () => {
    ...
    if (!sessionId) {
      response =
        "Please run a simulation first to generate a report. Configure the parameters on the left and click Generate Intelligence Report.";
