          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-5 items-start">
            <div className="lg:col-span-3 bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden flex flex-col">
              <div className="flex items-center justify-between px-5 py-3.5 border-b border-gray-100 shrink-0">
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-widest text-[#6B46C1] mb-0.5">USGS Data</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className={`w-7 h-7 rounded-lg flex items-center justify-center transition-all ${
                      loading ? "bg-gray-100 text-gray-300 cursor-not-allowed" : "bg-[#6B46C1]/10 text-[#6B46C1] hover:bg-[#6B46C1]/20"
                    }`}
                  >
    ...
    <div className="bg-white border border-gray-200 rounded-2xl shadow-sm flex flex-col" style={{ height: "520px" }}>
      <div className="px-5 py-4 border-b border-gray-100 shrink-0">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-[10px] font-bold uppercase tracking-widest text-[#6B46C1] mb-0.5">Live Feed</p>
